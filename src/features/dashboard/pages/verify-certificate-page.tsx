...
export default function VerifyCertificatePage() {
  ...
  useEffect(() => {
    ...
    apiClient
      .get<VerifyResult>(
        ENDPOINTS.CERTIFICATES.VERIFY(verificationId),
      )
        ...
        >
          ...
          <div className="relative text-center mb-10">
            ...
            {data.course.ar_title && (
              <p className="text-slate-400 text-lg mt-1 font-arabic">{data.course.ar_title}</p>
            )}
          </div>
          ...
          <div className="relative text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white">{data.user.name}</h2>
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            ...
            <div className="bg-white/5 rounded-xl p-4 text-center">
              ...
              <p className="text-white font-semibold text-sm truncate">{data.course.title}</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 text-center">
              ...
              <p className={`font-semibold text-sm ${isValid ? 'text-green-400' : 'text-red-400'}`}>
                {data.status}
              </p>
            </div>
          </div>
          ...
          <div className="relative border border-white/10 rounded-xl p-4 bg-white/5">
            <p className="text-slate-400 text-xs uppercase tracking-wider mb-2">Verification ID</p>
            <div className="flex items-center justify-between gap-3">
              <code className="text-cyan-300 font-mono text-sm break-all">{data.verificationId}</code>
              <button
                onClick={handleCopy}
