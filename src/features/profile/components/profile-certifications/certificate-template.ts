...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .inner-border { position: absolute; inset: 9px; border: 1px solid rgba(15,118,110,.24); pointer-events: none; }
  .c { position: absolute; width: 44px; height: 44px; }
  .c.tl { top: 0; left: 0; border-top: 5px solid #d97706; border-left: 5px solid #d97706; }
  .c.tr { top: 0; right: 0; border-top: 5px solid #d97706; border-right: 5px solid #d97706; }
  .c.bl { bottom: 0; left: 0; border-bottom: 5px solid #d97706; border-left: 5px solid #d97706; }
  .c.br { bottom: 0; right: 0; border-bottom: 5px solid #d97706; border-right: 5px solid #d97706; }
  .wm {
  ...
  .brand   { font-family: Arial, sans-serif; font-size: 18px; font-weight: 900; color: #0f766e; letter-spacing: .3em; text-transform: uppercase; margin-bottom: 1px; }
  .academy { font-family: Arial, sans-serif; font-size: 9.5px; color: #6b7280; letter-spacing: .38em; text-transform: uppercase; margin-bottom: 10px; }
  .divider { width: 96px; height: 2px; margin-bottom: 12px; background: linear-gradient(90deg, transparent, #d97706, transparent); }
  .cert-title { font-size: 23px; font-weight: 400; color: #111827; letter-spacing: .1em; text-transform: uppercase; margin-bottom: 3px; }
  .certifies  { font-family: Arial, sans-serif; font-size: 10.5px; color: #9ca3af; letter-spacing: .18em; text-transform: uppercase; margin-bottom: 10px; }
  .name-wrap  { border-bottom: 2px solid #0f766e; padding: 0 52px 5px; margin-bottom: 10px; }
  .name       { font-size: 30px; font-style: italic; color: #0f766e; letter-spacing: .04em; text-align: center; }
  .completed-txt { font-family: Arial, sans-serif; font-size: 10.5px; color: #374151; margin-bottom: 5px; text-align: center; }
  .course-name   { font-size: 17px; font-weight: 700; color: #111827; text-align: center; margin-bottom: 2px; }
  .type-label    { font-family: Arial, sans-serif; font-size: 9.5px; color: #9ca3af; letter-spacing: .22em; text-transform: uppercase; margin-bottom: 14px; }
  .footer        { display: flex; justify-content: space-between; align-items: flex-end; width: 100%; padding: 0 6px; }
  ...
  .verified   { display: inline-block; background: #d1fae5; border: 1px solid #0f766e; border-radius: 999px; padding: 2px 10px; margin-top: 3px; font-family: Arial, sans-serif; font-size: 8px; color: #0f766e; letter-spacing: .1em; text-transform: uppercase; }
</style>
</head>
<body>
<div class="cert">
...
/**
 * يفتح نافذة جديدة ويطبع الشهادة.
 * @param onPopupBlocked - callback يُستدعى لو المتصفح منع النافذة بدل alert()
 */
